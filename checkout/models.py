...
class OrderLineItem(models.Model):
    ...
    designproduct = models.ForeignKey(Product, null=False, blank=False,
                                      on_delete=models.CASCADE)
    ...
    def save(self, *args, **kwargs):
        ...
        """
        self.lineitem_total = self.designproduct.price * self.quantity
        super().save(*args, **kwargs)

    def __str__(self):
        return f'SKU {self.designproduct.sku} on order {self.order.order_number}'  # noqa
